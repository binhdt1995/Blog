...
namespace Abit\Blog\Ui\Component\Listing\Post\Column;
...
{
    /** Url path*/
    const POST_EDIT_URL = 'abit_blog/post/addpost';
    /**
     * @var mixed|string
     */
    private $_editUrl;
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                foreach ($actions as $key => $action) {
                    ...
                    if (isset($action['params']['post_id']) && isset($item[$action['params']['post_id']])) {
                        $parameters['post_id'] = $item[$action['params']['post_id']];
                    }
